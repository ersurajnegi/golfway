...
const Bin = ({ ...props }) => {
    return (
      ...
      <svg
           viewBox="0 0 512 512" strokeWidth="1.5" width="21"
               height="21">
     
      <path className={s.bin0} d="M213.4,30.9h85.6v14.4h30.9V28.9C329.8,13,316.9,0,301,0h-89.6c-15.9,0-28.9,13-28.9,28.9v16.4h30.9V30.9z"/>
      <path className={s.bin0} d="M401.2,167.8H111.1c-7.9,0-14.2,6.8-13.6,14.7l24.3,299.9c1.4,16.7,15.3,29.6,32.1,29.6h204.5
      ...
      <path className={s.bin0} d="M454.6,120.1l-10.1-30.4c-2.7-8-10.2-13.4-18.6-13.4H86.4c-8.5,0-16,5.4-18.6,13.4l-10.1,30.4
